        	...
        	<div className="home-slideshow">
            	<div className="slide slideshow--medium">
                	<div className="blur-up lazyload">
                        <img className="blur-up lazyload" data-src="assets/images/slideshow-banners/home12-category-banner1.jpg" src="assets/images/slideshow-banners/home12-category-banner1.jpg" alt="Outfit of Today" title="Outfit of Today" />
                            ...
                            <div className="slideshow__text-content classic left">
                            	<div className="container">
                                    <div className="wrap-caption left">
                                        <h2 className="h1 mega-title slideshow__title">Outfit of Today</h2>
                                        <span className="mega-subtitle slideshow__subtitle">Lookbook ss 2018</span>
                ...
                <div className="slide slideshow--medium">
                	<div className="blur-up lazyload">
                        <img className="blur-up lazyload" data-src="assets/images/slideshow-banners/home12-category-banner2.jpg" src="assets/images/slideshow-banners/home12-category-banner2.jpg" alt="Accessories" title="Accessories" />
                        <div className="slideshow__text-wrap slideshow__overlay classic middle">
                            <div className="slideshow__text-content classic left">
                            	<div className="container">
                                    <div className="wrap-caption left">
                                        <h2 className="h1 mega-title slideshow__title">Accessories</h2>
                                        <span className="mega-subtitle slideshow__subtitle">New Collection A-W ss18</span>
                	...
                	<div className="col-12 col-sm-12 col-md-12 col-lg-12">
						...
						<div className="productSlider grid-products grid-products-hover-gry">
                            <div className="col-12 item">
                                <div className="product-image">
                                    ...
                                    <form className="variants add" action="#" >
                                        <button className="btn btn-addto-cart" type="button" >Add To Cart</button>
                                    </form>
                            ...
                            <div className="col-12 item">
                                <div className="product-image">
                                    <a href="product-layout-1.html" className="grid-view-item__link">
                                        <img className="primary blur-up lazyload" data-src="assets/images/product-images/product-image4-1.jpg" src="assets/images/product-images/product-image4-1.jpg" alt="image" title="product" />
                                        <img className="hover blur-up lazyload" data-src="assets/images/product-images/product-image4.jpg" src="assets/images/product-images/product-image4.jpg" alt="image" title="product" />
                                    </a>
                            ...
                            <div className="col-12 item">
                                <div className="product-image">
                                    <a href="product-layout-1.html" className="grid-view-item__link">
                                        <img className="primary blur-up lazyload" data-src="assets/images/product-images/product-image5.jpg" src="assets/images/product-images/product-image5.jpg" alt="image" title="product" />
                                        <img className="hover blur-up lazyload" data-src="assets/images/product-images/product-image5-1.jpg" src="assets/images/product-images/product-image5-1.jpg" alt="image" title="product" />
                                    </a>
                                    <form className="variants add" action="#">
                                        <button className="btn btn-addto-cart" type="button">Select Options</button>
                                    </form>
        ...
        <div className="section feature-content">
            <div className="container">
                <div className="row">
                    <div className="feature-row">
                        <div className="col-12 col-sm-12 col-md-6 feature-row__item text-center">
                            <img className="blur-up lazyload" data-src="assets/images/collection/home12-category-bnr3.jpg" src="assets/images/collection/home12-category-bnr3.jpg" alt="Nuke New Arrivals" title="Nuke New Arrivals" />
                        </div>
                        <div className="col-12 col-sm-12 col-md-6 feature-row__item feature-row__text feature-row__text--left text-left">
                            <div className="row-text">
